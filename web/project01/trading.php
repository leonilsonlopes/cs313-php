				...
				<div class="dropdown-menu">
					...
					<?php
						...
						foreach (getListOfCurrencies() as $row){	
							...
							echo '<div class="dropdown-divider"></div><a class="dropdown-item" onclick="document.getElementById(\'selectedCoin\').innerHTML=\'' . $row['code'] . '\';alert(\''. $row['code'] .'\');">' . $row['code'] . ' - ' . $row['name'] .'</a>';						
						}
					?>			
